...
use Willydamtchou\SymfonyThirdpartyAdapter\Service\ConfirmService;
use Willydamtchou\SymfonyThirdpartyAdapter\Service\StatusService;
use FOS\RestBundle\Controller\Annotations\Post;
use FOS\RestBundle\Controller\Annotations\Route;
use Willydamtchou\SymfonyThirdpartyAdapter\Lib\Controller\ConfirmController as BaseConfirmController;
...
class ConfirmController extends AbstractController implements BaseConfirmController
{
    ...
    {
        $transaction = $this->confirmService->confirm($transactionId);
