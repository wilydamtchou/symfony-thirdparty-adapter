...
class OptionManager implements BaseOptionManager
{
    ...
    protected string $class = Option::class;
    ...
    {
        $entity = $this->entityManager->getRepository($this->class)->findOneByOptionId($optionId);
    ...
    {
        $entities = $this->entityManager->getRepository($this->class)->findAllByReference($reference);
    ...
    {
        $entities = $this->entityManager->getRepository($this->class)->findAllByReference();
    ...
    {
        $entity = $this->entityManager->getRepository($this->class)->findOneBy([AppConstants::REFERENCE => $reference, AppConstants::SLUG => $slug]);
     ...
     * @throws \Exception
     */
    protected function generateEntity(Option $entity): Option
    {
